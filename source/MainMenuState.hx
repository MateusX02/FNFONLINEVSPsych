...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "X02Engine version: " + matEngineVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://www.youtube.com/channel/UCpd0Wahwx78Sb_dVFQmIGSQ');
				}
				else
				{
					selectedSomethin = true;
