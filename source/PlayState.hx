...
// STAGE SCRIPTS
		...
		*/
		...
		if (!ClientPrefs.noAntimash) {
                        versionTxt = new FlxText(5, FlxG.height - 24, 0, SONG.song + " - " + CoolUtil.difficultyString() + " | Made by MateusX02 " , 16);
                }
                else if (ClientPrefs.noAntimash) {
                        versionTxt = new FlxText(5, FlxG.height - 24, 0, SONG.song + " - " + CoolUtil.difficultyString() + " | Made by MateusX02 | no Antimash! " , 16);
                }
